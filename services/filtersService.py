class FiltersService:
    ...
    # def elegir_filtros(self, filtros):
    ...
    #                 print(f"Se quitó '{palabra_elegida}' de la lista.")
    #             else:
    ...
    #                 print(f"Se agregó '{palabra_elegida}' a la lista.")
    ...
    def filtrar_datos(self, empresas_a_filtrar, parametros):
